...
class CIBlockPropertyCProp
{
    ...
    public static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
    {
        ...
        foreach ($arFields as $code => $arItem){
            if($arItem['TYPE'] === 'string'){
                ...
                $result .= self::getEditFormHTML($value, $strHTMLControlName);
            }
        }
    ...
    public static function getEditFormHTML($arUserField, $arHtmlControl)
    {
        ...
        CFileMan::AddHTMLEditorFrame(
            "DESCRIPTION",
            $arUserField["DESCRIPTION"],
            "DESCRIPTION_TYPE",
            $arUserField["DESCRIPTION_TYPE"],
    ...
    private static function getOptionList($selected = 'string')
    {
        ...
        $arOption = [
            ...
            'customhtml' => Loc::getMessage('IEX_CPROP_FIELD_TYPE_CUSTOM_HTML')
        ];
